---
title: “分布式数据库测试”这件小事：开发守质量，测试拓纵深
...
- 2026-03-02：补充核心总结：一是质量责任前移到开发，通过 CI、分层自动化与流程标准化，让开发对特性质量负责，测试更多承担赋能与机制建设；二是测试本身也有专门战场，在性能、稳定性、正确性等系统级垂直领域，需要长期积累方法和工具（如压测、混沌、模型/一致性验证），这部分通常需要专职测试工程能力。
